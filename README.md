...
**_Observação: este projeto não recebe mais atualizações desde 2021 por conta da equipe de TI ser muito reduzida e, por consequência, sobrar pouquíssimo tempo para testar / realizar melhorias / corrigir falhas neste software._**
...
<table>
  <tr>
    <td align="center">
      <a href="https://github.com/tecnologiacmbbauru" target="_blank">
        <img src="https://avatars.githubusercontent.com/u/14844050?v=4" width="100px;" alt="Foto Câmara Municipal de Bauru"/><br>
        <sub>
          <b>Serviço Tecnológico em Informática Câmara Municipal de Bauru</b>
        </sub>
      </a>
    </td>
    <td align="center">
