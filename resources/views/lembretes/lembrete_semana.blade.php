...
<div class="card-deck" style="padding-left:10px; padding-right:10px; margin-bottom:10px;">
    @foreach ($atendimentos as $atendimento)
            ...
            <div id="card{{$i}}" class="card" style="width: 15rem; border: 1px solid rgb(160, 160, 38);">
                <div class="card-header card-header-warning">Expira em {{date('d/m/Y', strtotime($atendimento->dat_lembrete))}}</div> 
            @endif
...
<div style="margin-bottom: 3%;">
    @if($atendimentos->nextPageUrl() != null)
        <a href="{{$atendimentos->appends(['select-lembrete'=>$exibir,'atendimentos'=>$atendimentos->currentPage()])->nextPageUrl()}}" style="float:right;"><img src="{{asset('utils/right-arrow.png')}}"></a>
    @endif  
    @if($atendimentos->previousPageUrl() != null)
        <a href="{{$atendimentos->appends(['select-lembrete'=>$exibir,'atendimentos'=>$atendimentos->currentPage()])->previousPageUrl()}}" style="float:left;"><img src="{{asset('utils/right-arrow.png')}}" style="transform: rotate(180deg);"></a>
    @endif
</div>
...
<div class="card-deck" style="padding-left:10px; padding-right:10px;">
    @foreach ($documentos as $documento)
        <!--<div class="col-md-3">-->
                ...
                @else
                <div id="card{{$i}}" class="card" style="width: 15rem; border: 1px solid rgb(160, 160, 38);">
                    <div class="card-header card-header-warning">Expira em {{date('d/m/Y', strtotime($documento->dat_lembrete))}}</div> 
                @endif
...
@if($documentos->nextPageUrl() != null)
    <a href="{{$documentos->appends(['select-lembrete'=>$exibir,'documentos'=>$documentos->currentPage()])->nextPageUrl()}}" style="float:right;"><img src="{{asset('utils/right-arrow.png')}}"></a>
@endif  
@if($documentos->previousPageUrl() != null)
    <a href="{{$documentos->appends(['select-lembrete'=>$exibir,'documentos'=>$documentos->currentPage()])->previousPageUrl()}}" style="float:left;"><img src="{{asset('utils/right-arrow.png')}}" style="transform: rotate(180deg);"></a>
@endif
<script>
