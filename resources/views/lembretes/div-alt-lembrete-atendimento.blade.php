<div class="form-row" id="div_dat_lembrete">
    <div class="form-group col-md-12">
        <div class="form-inline">
            ...
            <b>Data do lembrete:</b> <input class="form-control input-lembrar" id="dat_lembrete" name="dat_lembrete" type="date" style="margin-left:5px; margin-right:5px;" value="{{$atendimentoC->dat_lembrete}}">
        </div>
    </div>
</div>
