...
<head>
   ...
   <script src="{{ asset('js/app.js') }}"></script>
    ...
    <link href="{{ asset('css/tenants/tenants.css') }}" rel="stylesheet">
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md nav-principal navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ url('tenants/tenants') }}">
                <b>Administração</b>
                ...
                @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{route('usuario.editar',Auth::user()->id)}}">Configurações</a>
